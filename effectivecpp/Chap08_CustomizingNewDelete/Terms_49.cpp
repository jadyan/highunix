...
void Test3() {
	...
	/*
	https://blog.csdn.net/a_Treasure/article/details/82106638
	*/
	std::string *pw1 = new (std::nothrow) std::string(); //如果分配失败返回nullptr
	if(pw1 == nullptr) {
		cout<<"string 分配失败"<<endl;
	}else{
		cout<<"string 分配成功"<<endl;
	}
}
...
int main() {
	//Test1();
	//Test3();
	custommemorymanagement::Test1();
	//custommemorymanagement::Test2();
}
