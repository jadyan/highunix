/*
 * @Author: your name
 * @Date: 2021-02-05 10:35:09
 * @LastEditTime: 2021-02-05 10:35:09
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: /jadyan/code/book/CppConcurrency/ATMSample-master/source/core/userstatement.hpp
 */
//
      ...
      for (;;)
      {
        incoming.wait()
            ...
            .handle<display_balance>([&](display_balance const &msg) {
              ...
              std::cout << "当前账户余额： " << msg.amount << std::endl;
              
            })
            .handle<display_withdrawal_options>([&](display_withdrawal_options const &msg) {
              std::cout << "(取款50w)Withdraw 50? (w)" << std::endl;
              std::cout << "(显示账户余额)Display Balance? (b)" << std::endl;
              std::cout << "(取消)Cancel? (c)" << std::endl;
            })
