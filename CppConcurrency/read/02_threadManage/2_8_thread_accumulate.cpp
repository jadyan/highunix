/*
 * @Author: your name
 * @Date: 2021-01-22 17:51:42
 * @LastEditTime: 2021-01-27 13:38:13
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /jadyan/code/book/CppConcurrency/read/2.8.cpp
 */
...
T parallel_accumulate(Iterator first, Iterator last, T init) {
    //std::distance 返回两个迭代器之间的距离，也可以理解为计算两个元素 first 和 last 之间的元素数。
