...
/*
https://github.com/piotrek24061988/MultiThreadingCpp11/blob/master/9/9_1/main.cpp
*/
...
int main()
{
    ...
    tp.submit(f2);
    tp.submit(f3);
    tp.submit([](){cout << "f4" << endl; this_thread::sleep_for(std::chrono::seconds(5));});
    this_thread::sleep_for(std::chrono::seconds(5));
    cout << "------------------------------" << endl;
}