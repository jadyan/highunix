/*
 * @Author: your name
 * @Date: 2021-01-27 11:11:39
 * @LastEditTime: 2021-01-27 13:31:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /jadyan/code/book/CppConcurrency/read/my_accumulate.cpp
 */
#include <vector>
#include <numeric>
#include <functional>
...
int main( int argc, char **argv) 
{
   ...
   https://www.jianshu.com/p/3ac867dcdad1
   */
